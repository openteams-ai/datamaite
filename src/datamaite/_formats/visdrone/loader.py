...
:class:`datamaite.model.BoxTrackDataset` model. Loading is best-effort:
...
class VisDroneVideoLoader(Loader):
    ...
    convenience wrapper or ``datamaite.load(root,
...
def load_visdrone_video(
    ...
    *,
    ...
    Equivalent to ``datamaite.load(root, dataset_format="visdrone_video", ...)``.
