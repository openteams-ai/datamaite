...
:class:`datamaite.model.BoxTrackDataset` model. It intentionally mirrors the
...
class MotChallengeLoader(Loader):
    ...
    ``datamaite.load(root, dataset_format="motchallenge", ...)`` for the
...
def load_motchallenge(
    ...
    *,
    ...
    Equivalent to ``datamaite.load(root, dataset_format="motchallenge", ...)``.
