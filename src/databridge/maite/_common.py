...
These turn databridge's neutral :class:`~databridge.model.BoxAnnotation`s into
the numpy arrays MAITE's target protocols expect, build the fallback
:class:`~databridge.maite._decode.VideoInfo` used when a video can't be probed,
...
from databridge.maite._decode import Decoder, VideoInfo, resolve_video_info
from databridge.model import BBox, BoxAnnotation, VideoSequence
