...
boxes. The writer consumes :class:`~databridge.model.VideoClassificationDataset`
...
from databridge.model import VideoClassificationDataset, VideoClassificationSample, VisionDataset
