...
from databridge.model import VideoClassificationDataset, VideoClassificationSample
...
def load_huggingface_video_classification(
    ...
    *,
    ...
    Equivalent to ``databridge.load(root, dataset_format="huggingface_video_classification")``.
