...
those sequences requires the optional ``databridge[video]`` extra. Source TAO
...
from databridge.writers import Writer, register_writer
...
class TaoWriter(Writer):
    ...
    def write(
        ...
        **_options: Any,
        ...
        images with OpenCV and therefore require ``databridge[video]``. Video
...
def _extract_video_frames(
    ...
    *,
    ...
    try:
        ...
        raise ImportError(
            "Writing video-backed sequences to TAO requires OpenCV. Install it with: pip install databridge[video]"
        ) from exc
